...
- [Section 1.](https://github.com/slicex-ai/elm-turbo/edit/main/README.md#1-run-elm-turbo-models-with-huggingface-transformers-library) contains instructions to run ELM-Turbo with the Huggingface Transformers library :hugs:.
- [Section 2.](https://github.com/slicex-ai/elm-turbo/edit/main/README.md#2-running-elm-turbo-via-nvidias-tensorrt-llm) contains instructions to run ELM-Turbo engines powered by NVIDIA's TensoRT-LLM. 
